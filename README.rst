...
See the Wiki entry at `ORM Quick Wins Proof of Concept <https://wiki.openstack.org/wiki/OpenStack_and_SQLAlchemy#ORM_Quick_Wins_Proof_of_Concept>`_ for an introduction.
